...
You can embed images, videos, and other media in your markdown content.
...
To add a caption below the image, use the following syntax

<Preview codeblock>
<Image src='https://via.placeholder.com/150' alt='Placeholder' caption='Caption' />
</Preview>
```markdown
<Image src='https://via.placeholder.com/150' alt='Placeholder' caption='Caption' />
```
