...
const FootnoteBackReference = dynamic(
  () => import("@/components/footnote/back-reference"),
  {
    ssr: false,
  },
);

const FootnoteForwardReference = dynamic(
  () => import("@/components/footnote/forward-reference"),
  {
    ssr: false,
  },
);
...
const components: MDXComponents = {
  Preview: ({ children, codeblock }) => (
    <Preview codeblock={codeblock}>{children}</Preview>
  ),
